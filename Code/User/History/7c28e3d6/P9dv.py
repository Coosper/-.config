...
# Create the instance
instance = ec22.create_instances(
    ImageId=DEFAULT_AMI,
...
print(f"Instance created: {instance[0].id} " f"Instance Name: {INSTANCE_NAME}")
...
print(f"Instance is running: {instance[0].id}  " f"Instance Name: {INSTANCE_NAME}")
